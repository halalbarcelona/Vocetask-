...
export function SettingsIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M19.4 13.5a7.9 7.9 0 0 0 0-3l2-1.4-2-3.4-2.3.8a7.9 7.9 0 0 0-2.6-1.5L14 2.5h-4l-.5 2.5a7.9 7.9 0 0 0-2.6 1.5l-2.3-.8-2 3.4 2 1.4a7.9 7.9 0 0 0 0 3l-2 1.4 2 3.4 2.3-.8a7.9 7.9 0 0 0 2.6 1.5l.5 2.5h4l.5-2.5a7.9 7.9 0 0 0 2.6-1.5l2.3.8 2-3.4-2-1.4Z" />
    </svg>
  )
}
...
export function TrashIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M6 6.5 6.8 19a1.5 1.5 0 0 0 1.5 1.4h7.4a1.5 1.5 0 0 0 1.5-1.4l.8-12.5" />
    </svg>
  )
}
...
export function CommandIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M8 4.5a2 2 0 1 1 2 2H6a2 2 0 1 1 2-2Zm0 15a2 2 0 1 0 2-2H6a2 2 0 1 0 2 2Zm8-15a2 2 0 1 1 2 2h-4a2 2 0 1 1 2-2Zm0 15a2 2 0 1 0 2-2h-4a2 2 0 1 0 2 2ZM8 6.5v11M16 6.5v11" />
    </svg>
  )
}
